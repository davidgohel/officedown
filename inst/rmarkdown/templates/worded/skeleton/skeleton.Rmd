...
Ce `r chunk_ftext("document", textfp(color = "red", shading.color = "yellow"))` présente la plupart des fonctionnalités du package `worded`. 
...
<!---MACRO_MULTICOL_STOP{widths=c(3,3), space=.2, sep=TRUE}--->
...
```{r, fig.cap="plotting example", echo=FALSE}
barplot(1:10)
```
