...
The customization of the tables according to Word rules is possible with the
...
> there's no feature to apply a style to individual cells.
...
|-------------|-----------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `style` | `tab.style` | the Word style name to use for tables. This is a __table style__. You can access them in the Word template used. Function `officer::styles_info(doc, type = "table")` lets you read these styles. |
...
| `caption` |  |  |
|&nbsp;&nbsp;&nbsp;&nbsp;`style` | `tab.cap.style` | Word style name to use for table captions.You can access them  in the Word template used. Function `officer::styles_info(doc, type = "paragraph")` can let you read these styles. |
...
Once you are happy with the style, save the document - the style is stored within 
the word document. 
